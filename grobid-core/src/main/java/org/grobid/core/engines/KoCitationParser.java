...
public class KoCitationParser extends AbstractParser {
    private static final Logger LOGGER = LoggerFactory.getLogger(KoCitationParser.class);

    public Lexicon lexicon = Lexicon.getInstance();
    private EngineParsers parsers;

    public KoCitationParser(EngineParsers parsers, CntManager cntManager) {
        super(GrobidModels.CITATION, cntManager);
        this.parsers = parsers;
    }

    public KoCitationParser(EngineParsers parsers) {
