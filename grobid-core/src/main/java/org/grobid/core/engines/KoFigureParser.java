...
import static org.grobid.core.engines.label.TaggingLabels.FIG_CONTENT;
...
class KoFigureParser extends AbstractParser {
    private static final Logger LOGGER = LoggerFactory.getLogger(KoFigureParser.class);
